...
func (wa *WhatsappCloudConnector) mediaEditCacheExpireLoop(ctx context.Context) {
...
func (wa *WhatsappCloudConnector) AddMediaEditCache(
...
func (wa *WhatsappCloudConnector) GetMediaEditCache(
	portal *bridgev2.Portal,
	messageID networkid.MessageID,
...
func (wa *WhatsappCloudConnector) expireMediaEditCache() {
	wa.mediaEditCacheLock.Lock()
	defer wa.mediaEditCacheLock.Unlock()
