...
func (wa *WhatsappCloudConnector) GetCapabilities() *bridgev2.NetworkGeneralCapabilities {
	return WhatsAppGeneralCaps
}

func (wa *WhatsappCloudConnector) GetBridgeInfoVersion() (info, caps int) {
	return 1, 6
}
...
func (wa *WhatsappCloudClient) GetCapabilities(ctx context.Context, portal *bridgev2.Portal) *event.RoomFeatures {
